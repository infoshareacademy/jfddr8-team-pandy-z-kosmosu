...
export const Footer = () => {
    return (
     ...
     <ul>
        <li><span>Maja Karwacka-Frank</span><a href="https://github.com/maja-karwacka-frank"><img className={classes['footer-small-logos']} src={githubLogo} alt='github'/></a><a href="https://www.linkedin.com/in/maja-karwacka-frank/"><img className={classes['footer-small-logos']} src={liLogo} alt='LI'/></a></li>
        <li><span>Łukasz Śmigiel</span><a href="https://github.com/L-Smigiel"><img className={classes['footer-small-logos']} src={githubLogo} alt='github'/></a><a href="https://www.linkedin.com/in/lukasz-smigiel/"><img className={classes['footer-small-logos']} src={liLogo} alt='LI'/></a></li>
